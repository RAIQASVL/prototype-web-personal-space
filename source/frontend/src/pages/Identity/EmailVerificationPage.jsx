...
const EmailVerificationPage = () => {
  ...
  return (
    <div className="max-w-md w-full bg-transparent backdrop-filter backdrop-blur-xl rounded-full shadow-xl overflow-hidden">
      <motion.div
        initial={{ opacity: 0, y: -50 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.5 }}
        className=" bg-transparent bg-opacity-50 backdrop-filter backdrop-blur-xl rounded-full shadow-2xl p-20 w-full max-w-md"
      >
          ...
          <div className="flex justify-center gap-1">
            {code.map((digit, index) => (
              <input
                ...
                className="w-12 h-12 text-center text-2xl font-bold bg-transparent text-black 
                border-2 border-gray-500 rounded-full focus:outline-none focus:border-black focus:ring-offset-2 focus:ring-offset-black
                hover:border-black"
              />
            ))}
          </div>
